...
import type { OpportunityKeyword } from "@/lib/types";
...
export default function OpportunityKeywordsSection({ keywords }: Props) {
      ...
      {keywords.length === 0 ? (
        ...
        <>
          ...
          <p style={{ marginTop: "0.875rem", fontFamily: "var(--font-mono)", fontSize: "0.65rem", color: "var(--text-muted)" }}>
            Keywords not yet ranking in top 10, sorted by search volume. Bar = relative volume.
          </p>
        </>
      )}
    </div>
